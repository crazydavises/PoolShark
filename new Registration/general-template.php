...
function wp_logout_url($redirect = '') {
	...
	$logout_url = add_query_arg($args, site_url('lifestrokes-login2.php', 'login'));
...
function wp_login_url($redirect = '', $force_reauth = false) {
	$login_url = site_url('lifestrokes-login2.php', 'login');
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'lifestrokes-login2.php', 'login_post' ) ) . '" method="post">
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	$lostpassword_url = add_query_arg( $args, network_site_url('lifestrokes-login2.php', 'login') );
...
function wp_register( $before = '<li>', $after = '</li>', $echo = true ) {
	...
	if ( ! is_user_logged_in() ) {
		if ( get_option('users_can_register') )
			$link = $before . '<a href="' . site_url('lifestrokes-login2.php?action=register', 'login') . '">' . __('Register') . '</a>' . $after;
		else
			$link = '';
	} else {
